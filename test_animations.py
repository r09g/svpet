...
class AnimationTester(QWidget):
    def __init__(self):
        ...
        self.sprite_sheets = {
            'chicken': 'prompts/base_prompt/visualization/sprite_sheets/chicken_brown.png',
            'cat': 'prompts/base_prompt/visualization/sprite_sheets/cat_grey.png', 
            'dog': 'prompts/base_prompt/visualization/sprite_sheets/dog_brown.png',
            'duck': 'prompts/base_prompt/visualization/sprite_sheets/duck.png',
            'emote': 'prompts/base_prompt/visualization/sprite_sheets/emote.png'
        }
    ...
    def setup_animations(self):
        ...
        for anim_name, frames in animal_animations.items():
            self.animation_manager.create_animation(anim_name, frames, duration_per_frame=0.15, loop=True)
        
        for anim_name, frames in emote_animations.items():
            loop = anim_name not in ["enter", "exit"]
            self.animation_manager.create_animation(f"emote_{anim_name}", frames, duration_per_frame=0.15, loop=loop)
    ...
    def update_animation(self):
        ...
        if self.animation_manager.current_animation:
            ...
            self.frame_info.setText(f"Frame: {frame_index} (Animation: {self.animation_manager.current_animation})")
        else:
